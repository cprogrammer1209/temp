...
(async () => {
  ...
  await page.getByRole('button', { name: 'Login', exact: true }).click();
    ...
    const busCard = await page.locator('#serviceWiseScroll').innerHTML();
      ...
      console.log(text);
      // 2. Click RNR
  // await page.waitForSelector('.Header---ham_menu---gOm2d');
  // await page.locator('.Header---ham_menu---gOm2d').click();

  // // Scroll the target div
  // const scrollableDiv = await page.locator('//body/div[@id="root"]/div/div/div/div[3]');
  // await scrollableDiv.evaluate(el => el.scrollTop = el.scrollHeight);

  // await page.waitForTimeout(1000);
  // await page.locator('span:has-text("R & R")').click();

  // 3. Filter Data
  // await page.locator('input[placeholder="Source"]').fill('Pun');
  // await page.waitForTimeout(1000);
  // await page.locator('div:has-text("Pune")').click();

  // await page.locator('input[placeholder="Destination"]').fill('Nag');
  // await page.waitForTimeout(1000);
  // await page.locator('div:has-text("Nagpur")').click();
