...
def process_single_page_range(itr, page_output, prompt_format, table_obj, isTemplateBased, templateName, db, index):
...
def fieldDetection(data,timestamp):
            ...
            if table_obj:
                ...
                if checkTable is False:
                    ...
                    if getChunkFromLLM:
                        ...
                        chunkResponse =  make_api_call_with_retry(prompt)
    ...
    try:
        ...
        print (e)
    t2 = time.time()
    print("Total time taken for ingestion is --- ",t2-t1 )
