...
def process_single_page_range(itr, page_output, prompt_format, table_obj, isTemplateBased, templateData, index,content, invoice_obj):
    ...
    if 'type' in itr:
        ...
        if isTemplateBased:
            ...
            print("table_chat_format ",table_chat_format)
...
def fieldDetection(data,timestamp):
    ...
    webURLFileName = filename
    file_path = '/home/ubuntu/new_ssd/publicfolder/liberty-fs/aiqod-dev/'+filename
    webURL = file_path
    ...
    if model_name == 'openai':
        ...
        if document_obj:
            ...
            if  isTemplateBased:
                ...
                headerTemplate=templateData[0]['input']
                ...
                if 'ShipmentContainerDetails' in templateData  :
                    ...
                    if ShipmentContainerDetails:
                        ...
                        for item in table["ShipmentContainerDetails"]:
                            for key in item:
                                # print("key ",key in invoice_obj)
                                if not key in ShipmentContainerDetails:                                    
                                    item[key] = ""  # key not allowed → set empty
    ...
    invoice_obj['webURL'] = f"https://liberty-fs.gibots.com:843/aiqod-dev/{webURLFileName}"
