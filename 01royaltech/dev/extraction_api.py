...
def format_result(result):
    ...
    final_result = {}
    final_result['Header'] = [header_details]
    for item in table_details:
        for tablename in item:
            if tablename == 'Item Details':
                final_result['ItemsDetails'] = item[tablename]
            elif tablename == 'Invoice Details':
                final_result['InvoiceDetails'] = item[tablename]
            else:
